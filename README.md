...
--- size_5_1 ---
Cross MAC 결과: 0.9000000000
X MAC 결과: 0.9000000000
MAC 위치 수(N²): 25
판정: UNDECIDED | expected: X | FAIL
원인: 동점 규칙: |Cross-X| < 1e-09
Cross MAC 시간: 0.004977 ms
X MAC 시간: 0.006470 ms
평균 MAC 시간: 0.005724 ms

--- size_5_2 ---
Cross MAC 결과: 8.9000000000
X MAC 결과: 0.1000000000
MAC 위치 수(N²): 25
판정: Cross | expected: Cross | PASS
Cross MAC 시간: 0.007311 ms
X MAC 시간: 0.004302 ms
평균 MAC 시간: 0.005807 ms

--- size_13_1 ---
Cross MAC 결과: 0.3000000000
X MAC 결과: 14.7000000000
MAC 위치 수(N²): 169
판정: X | expected: X | PASS
Cross MAC 시간: 0.022679 ms
X MAC 시간: 0.022711 ms
평균 MAC 시간: 0.022695 ms

--- size_13_2 ---
Cross MAC 결과: 7.5000000000
X MAC 결과: 7.5000000000
MAC 위치 수(N²): 169
판정: UNDECIDED | expected: Cross | FAIL
원인: 동점 규칙: |Cross-X| < 1e-09
Cross MAC 시간: 0.022716 ms
X MAC 시간: 0.022771 ms
평균 MAC 시간: 0.022744 ms

--- size_25_1 ---
Cross MAC 결과: 4.9000000000
X MAC 결과: 4.9000000000
MAC 위치 수(N²): 625
판정: UNDECIDED | expected: X | FAIL
원인: 동점 규칙: |Cross-X| < 1e-09
Cross MAC 시간: 0.078772 ms
X MAC 시간: 0.078519 ms
평균 MAC 시간: 0.078646 ms

--- size_25_2 ---
Cross MAC 결과: 52.9000000000
X MAC 결과: 0.1000000000
MAC 위치 수(N²): 625
판정: Cross | expected: Cross | PASS
Cross MAC 시간: 0.079078 ms
X MAC 시간: 0.085612 ms
평균 MAC 시간: 0.082345 ms
...
패턴                크기              Cross(ms)          X(ms)         평균(ms)        MAC 위치 수(N²)
-----------------------------------------------------------------------------------------------
size_5_1          5x5              0.004977       0.006470       0.005724                  25
size_5_2          5x5              0.007311       0.004302       0.005807                  25
size_13_1         13x13            0.022679       0.022711       0.022695                 169
size_13_2         13x13            0.022716       0.022771       0.022744                 169
size_25_1         25x25            0.078772       0.078519       0.078646                 625
size_25_2         25x25            0.079078       0.085612       0.082345                 625
